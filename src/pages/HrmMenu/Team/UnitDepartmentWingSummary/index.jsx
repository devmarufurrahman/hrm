...
const UnitDepartmentSectionWingSummary = () => {
	const columns = [
		{
			title: "Unit Name",
			dataIndex: "name",
	...
	return (
		<div className="bg-white p-7 shadow-md rounded-lg">
			<Typography.Title
				...
				Unit Department Section Wing Summery
			</Typography.Title>
					...
					<Form.Item>
						<Space>
							...
							<table className="table-auto border-2 border-black">
								<th className="px-40 bg-green-100 py-2">Team Name</th>
							</table>
						</Space>
					</Form.Item>
...
export default UnitDepartmentSectionWingSummary;
